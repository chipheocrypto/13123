...
import { Printer, Eye, Save, Building, FileText, Clock, Database, Lock, Unlock, ShieldCheck } from 'lucide-react';
      ...
      {activeTab === 'SYSTEM' ? (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  ...
                  - Dùng 1 phút &rarr; Tính 10 phút. <br/>
                  - Dùng 11 phút &rarr; Tính 20 phút.
                </p>
              </div>
             ...
             <div className={`space-y-4 transition-opacity duration-300 ${!isRulesUnlocked ? 'opacity-50 pointer-events-none blur-[1px]' : ''}`}>
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="bg-gray-900 border border-gray-600 rounded p-2 w-full text-white"
                  />
                  <p className="text-xs text-gray-500 mt-1">Nhập 0 = Tắt (Duyệt tay). Nếu {'>'} 0: Yêu cầu sửa sẽ tự động duyệt nếu gửi trong khoảng này.</p>
                </div>
        ...
        <div className="flex flex-col xl:flex-row gap-6 h-[calc(100vh-140px)]">
          ...
          <div className="w-full xl:w-7/12 bg-gray-500 rounded-lg p-8 flex justify-center items-start overflow-y-auto">
             <div className="bg-white text-black p-8 w-[500px] shadow-2xl min-h-[600px] text-sm relative font-sans">
                <div className="absolute top-0 right-0 bg-pink-500 text-white text-xs px-2 py-1 font-bold">LIVE PREVIEW</div>
                
                <div className="flex justify-between items-start border-b-2 border-black pb-4 mb-4">
                   <div className="w-2/3 pr-4">
                      <h2 className="font-bold text-lg uppercase leading-tight">{settings.storeName}</h2>
                      <p className="text-xs mt-1">MST: {settings.storeTaxCode}</p>
                      <p className="text-xs mt-1">{settings.storeAddress}</p>
                   </div>
                ...
                <div className="text-center mb-6">
                   <h1 className="text-2xl font-bold uppercase">{settings.invoiceTitle}</h1>
                ...
                <table className="w-full text-sm mb-6 border-collapse border border-black">
                  <thead>
                ...
                <div className="text-center text-xs italic border-t pt-2">
